...
public class InGameMenuViewImpl implements View {
    ...
    class InGameMenuPanel extends JLayeredPane {
        ...
        InGameMenuPanel() {
            ...
            final ImageIcon background = new ImageIcon(new ImageIcon(this.getClass().getResource("/InGameMenu.png"))
            ...
            final ImageIcon resumeImage = new ImageIcon(new ImageIcon(this.getClass().getResource("/resumeButton.png"))
                    .getImage().getScaledInstance(IMAGE_WIDTH, IMAGE_HEIGHT, Image.SCALE_SMOOTH));
            final ImageIcon controlsImage = new ImageIcon(new ImageIcon(this.getClass().getResource("/controlsButton2.png"))
                    .getImage().getScaledInstance(IMAGE_WIDTH, IMAGE_HEIGHT, Image.SCALE_SMOOTH));
            final ImageIcon exitImage = new ImageIcon(new ImageIcon(this.getClass().getResource("/exitButton.png")).getImage()
                    .getScaledInstance(IMAGE_HEIGHT, IMAGE_HEIGHT, Image.SCALE_SMOOTH));
